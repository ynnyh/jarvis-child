...
function applyServerState(out) {
  ...
  useGameStore.setState((prev) => ({
    ...
    pet: {
      ...prev.pet,
      exp: eco.pet_exp ?? prev.pet.exp,
      level: eco.pet_level ?? prev.pet.level,
    },
    streak: {
      ...prev.streak,
      count: eco.streak_count ?? prev.streak.count,
      lastDay: eco.streak_last_day ?? prev.streak.lastDay,
    },
  }));
}
